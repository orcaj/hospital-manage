                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-header space-bet">
                                <h3 class="card-title" id="emailCompose">
                                    Service List
                                </h3>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input type="checkbox" class="check_item" unikey="{{$service->id}}" id="test-{{$key}}" name="test-{{$key}}" data-size="sm">
                                                </td>
                                                @endif
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{$service->name}}</td>
...
<!-- END: Content-->
<!-- delete multi -->
<form id="multi-delete" action="{{route('servi.multi_delete')}}" method="post">
    @csrf
...
<!-- status multi -->
<form id="multi-status" action="{{route('servi.multi_status')}}" method="post">
    @csrf
...
<script type="text/javascript">
    $(function() {
        ...
        if (
            ...
            toastr.success(msg, action, {
                showMethod: "slideDown",
                hideMethod: "slideUp",
                timeOut: 1500
            });
        } else {
            toastr.error(msg, action, {
                showMethod: "slideDown",
                hideMethod: "slideUp",
                timeOut: 1500
            });
